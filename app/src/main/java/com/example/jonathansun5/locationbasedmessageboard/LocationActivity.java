...
public class LocationActivity extends AppCompatActivity implements LocationListener {
    ...
    private void makeBears() {
        ...
        Bears outsideStadium = new Bears(R.drawable.outside_stadium, "Stadium Entrance Bear", a2);
        ...
        Bears strawberryCreek = new Bears(R.drawable.strawberry_creek, "Strawberry Creek Topiary Bear", a5);
        Bears southHall = new Bears(R.drawable.south_hall, "South Hall Little Bear", a6);
        Bears bellBears = new Bears(R.drawable.bell_bears, "Great Bear Bell Bears", a7);
        Bears benchBears = new Bears(R.drawable.bench_bears, "Campanile Esplanade Bears", a8);
        mBears.add(mlkBear);
